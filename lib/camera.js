...
Camera.prototype.draw_rectangles = function(rectangles){
	var self = this;
	var i = 0;
	...
	rectangles.forEach(function(rect) {
		...
		self.b_c_ctx.strokeStyle = rect.colour;
		self.b_c_ctx.strokeRect(rect.x, rect.y, rect.width, rect.height);
		/*self.b_c_ctx.font = '11px Helvetica';
		self.b_c_ctx.fillStyle = "#fff";
		self.b_c_ctx.fillText('x: ' + rect.x + 'px', rect.x + rect.width + 5, rect.y + 11);
		self.b_c_ctx.fillText('y: ' + rect.y + 'px', rect.x + rect.width + 5, rect.y + 22);
		self.b_c_ctx.fillText('#: ' + i, rect.x + rect.width + 5, rect.y + 33);*/
	});
}

Camera.prototype.on_resize = function(){
