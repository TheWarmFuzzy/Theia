...
Overlay.prototype.set_object_position = function(object,x,y){
	...
	newPos.x = (newPos.x - object.position.x) * this.interpolation["position"] + object.position.x;
	newPos.y = (newPos.y - object.position.y) * this.interpolation["position"] + object.position.y;
...
Overlay.prototype.set_object_scale = function(object,scale){
	...
	scale = (scale - object.scale.x) * this.interpolation["scale"] + object.scale.x;
